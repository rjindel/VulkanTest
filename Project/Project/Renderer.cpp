...
bool Renderer::CreateShader()
{
	...
	graphicsCreatePipelineInfo.stageCount = 1;
	graphicsCreatePipelineInfo.pStages = &pipelineVertexShaderStageCreateInfo;
	...
	graphicsCreatePipelineInfo.pDynamicState = nullptr;
